...
\begin{document}
    ...
    \chapter{Password Cracking}\label{ch:lab6n}
    \input{lab6}
    ...
    \textbf{Heavily} reduce word count.
    You're near 5000 before the conclusion, ideally it should be 3000/3500 \textbf{MAX}.
